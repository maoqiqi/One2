...
//        val findFragmentByTag = supportFragmentManager.findFragmentByTag("")
        ...
        fragment?.let { if (!it.isAdded) ft.add(R.id.container, it, NavigationRoutePath.NAVIGATION_FRAGMENT).commit() else ft.show(it).commit() }
    }
}