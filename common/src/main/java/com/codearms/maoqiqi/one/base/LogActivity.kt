...
abstract class LogActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.e(tagName + number, "-->onCreate(@Nullable Bundle savedInstanceState)")
    ...
    override fun onAttachFragment(fragment: Fragment) {
        ...
        Log.e(tagName + number, "-->onAttachFragment(Fragment fragment) = " + fragment.javaClass.name)
    }

    // 在Activity已停止并即将再次启动前调用.始终后接onStart().
    override fun onRestart() {
        super.onRestart()
        Log.e(tagName + number, "-->onRestart()")
    }
    ...
    override fun onStart() {
        super.onStart()
        Log.e(tagName + number, "-->onStart()")
    }

    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        super.onRestoreInstanceState(savedInstanceState)
        Log.e(tagName + number, "-->onRestoreInstanceState(Bundle savedInstanceState)")
    }
    ...
    override fun onResume() {
        super.onResume()
        Log.e(tagName + number, "-->onResume()")
    }

    override fun onAttachedToWindow() {
        super.onAttachedToWindow()
        Log.e(tagName + number, "-->onAttachedToWindow()")
    }

    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        Log.e(tagName + number, "-->onCreateOptionsMenu(Menu menu)")
        return super.onCreateOptionsMenu(menu)
    }

    override fun onPrepareOptionsMenu(menu: Menu): Boolean {
        Log.e(tagName + number, "-->onPrepareOptionsMenu(Menu menu)")
    ...
    override fun onPause() {
        super.onPause()
        Log.e(tagName + number, "-->onPause()")
    }

    override fun onSaveInstanceState(outState: Bundle) {
        super.onSaveInstanceState(outState)
        Log.e(tagName + number, "-->onSaveInstanceState(Bundle outState)")
    }
    ...
    override fun onDestroy() {
        super.onDestroy()
        Log.e(tagName + number, "-->onDestroy()")
    }

    override fun onDetachedFromWindow() {
        super.onDetachedFromWindow()
        Log.e(tagName + number, "-->onDetachedFromWindow()")
    }

    override fun onConfigurationChanged(newConfig: Configuration) {
        super.onConfigurationChanged(newConfig)
        Log.e(tagName + number, "-->onConfigurationChanged(Configuration newConfig)")
